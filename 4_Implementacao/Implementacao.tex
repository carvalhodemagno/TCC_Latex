...
Conforme citado na seção \ref{section_hardware}, o ESP8266EX apresenta a interface Wi-Fi como uma funcionalidade integrada ao CI, característica que facilita o desenvolvimento do \textit{firmware} para as funcionalidades básicas do Wi-Fi como: 
\begin{itemize}
