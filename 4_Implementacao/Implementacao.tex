...
O desenvolvimento do \textit{hardware} iniciou-se com o levantamento dos circuitos elétricos necessários para cumprir as funções requeridas conforme a concepção do projeto, sendo eles: \textbf{Circuito de Conexão com \textit{Wi-Fi}}, \textbf{Circuito de Ativação do Condicionador de Ar} e \textbf{Circuito de Monitoramento}. O Circuito de Conexão com \textit{Wi-Fi} é  responsável por trocar informações com o aplicativo mobile, utilizando o protocolo MQTT. O Circuito de Ativação do Condicionador de Ar é responsável  por permitir ou não a alimentação elétrica desse dispositivo. E o Circuito de Monitoramento é responsável por realizar as medições provenientes da rede elétrica como tensão, corrente, fator de potência e frequência com intuito de definir se os níveis estão adequados ao condicionador de ar e verificar a presença ou ausência humana onde o equipamento está instalado.
