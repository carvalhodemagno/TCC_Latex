...
Já o \textit{Firmware} é responsável pela inteligência agregada ao \textit{hardware}, capaz de gerenciar e controlar periféricos, como botões, chaves, diodos de emissão de luz (LEDs), circuitos integrados e etc. O \textit{firmware} é embarcado em um componente eletrônico, chamado microcontrolador, sendo aqui desenvolvido na plataforma Arduino, versão 1.8.7. 
